...
6.<div align=left><img src="https://raw.githubusercontent.com/ieigen/secret/master/docs/images/Unlock%20Wallet%20Signature%20Request.png" width="270px"></div>

7.Perform key backup according to the message at the top
...
8.Select key backup content: you can select secret recovery phrase or private key, and set the name and description of the backup. As follows, make a backup by secret recovery phrase.
...
9.2FA Attachment: Download Google Authenticator through App Store. Scan the QR code in the Google Authenticator page, then enter 6-digit code corresponding to EigenNetwork in Google Authenticator.
...
10.If you jump to the following page, it means that you have completed the attachment through Google Authenticator and the verification is successful. Click confirm to proceed with the key backup process.
...
11.Add friends and wait for the their reply to confirm the relationship. Click refresh to see the status of friends.
...
13.Select at least two friends, send the secret share to the their mailbox, and authorize Gmail.
...
15.Complete authorization on Google Page
...
16.Tick authorized access content. Just select all by default.
...
18.The secret share is sent successfully. The selected friends will receive secret share. You can recover the key through the social recovery.
...
3.Enter 6-digit code as Google Authenticator code
...
2.Select secret recovery phrase or private key.
